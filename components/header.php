...
<body>
    ...
    <header class="erbot-navbar">
        <div class="container">
            <a href="index.php" class="nav-logo" title="">
                <img src="img/nav-logo.svg" alt="">
            </a>

            <button class="btn-menu btn-drop"><span>Menu</span></button>
            ...
            <nav class="nav-menu" role="navigation">
                <ul class="menu-lista">
                    ...
                    <li><a href="page-trabalhos-cientificos.php" title="">Trabalhos</a></li>
                    <!-- <li><a href="page-minicursos.php" title="">Minicursos</a></li> -->
                    <li><a href="page-concurso.php" title="">Concurso de ilustração</a></li>
                </ul>
            </nav>
        </div>
</header>